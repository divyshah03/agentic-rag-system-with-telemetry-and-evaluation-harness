...
<img src="docs/images/query-with-routing.png" width="420" alt="A question answered from retrieved PDF context, with the confidence gate re-retrieving on a low-confidence top result">
